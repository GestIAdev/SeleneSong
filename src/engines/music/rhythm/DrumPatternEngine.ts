...
export class DrumPatternEngine {
    ...
    private swingAmount: number = 0.12 // 🎭 SCHERZO: 12% swing (más shuffle feel en cyberpunk)
    private humanizationFactor: number = 0.06 // 🎭 SCHERZO: 6% variación (menos saltos bruscos)
