...
class StabilityValidator {
    ...
    async validateDeterminism() {
        ...
        try {
            ...
            this.results.push({
                test: "Determinismo del Sistema",
                passed: false,
                message: `❌ Error en validación determinista: ${error.message}`,
                metrics,
                duration: Date.now() - start,
            });
        }
    }
    async validateMemoryStability() {
    ...
    async validatePostgreSQLConnections() {
        ...
        try {
            ...
            this.results.push({
                test: "Conexiones PostgreSQL",
                passed: false,
                message: `❌ Error de conexión PostgreSQL: ${error.message}`,
                metrics,
                duration,
            });
        }
    }
    async validateImmuneSystem() {
        ...
        try {
            ...
            this.results.push({
                test: "Sistema Inmune Operativo",
                passed: false,
                message: `❌ Error en validación del sistema inmune: ${error.message}`,
                metrics,
                duration,
            });
        }
    }
    async validateSwarmNodes() {
        ...
        try {
            ...
            const coordinatorPath = path.join(swarmPath, "coordinator/SeleneNuclearSwarm.ts");
            ...
            this.results.push({
                test: "Nodos Reales del Swarm",
                passed: false,
                message: `❌ Error en validación de nodos del swarm: ${error.message}`,
                metrics,
                duration,
            });
        }
    ...
    printResults() {
        ...
        console.log(`📈 Resumen: ${passed}/${total} tests pasaron (${successRate}%)\n`);
...
//# sourceMappingURL=stability-validation-4.1.js.map