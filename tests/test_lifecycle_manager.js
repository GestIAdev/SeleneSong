 ...
 */
import { lifecycleManager, } from "../shared/ComponentLifecycleManager";
...
async function testComponentLifecycleManager() {
    ...
    try {
        ...
        lifecycleManager.registerEventListener("test-component-1", comp2, "data-added", (_data) => console.log(`Comp1 escuchó: ${_data}`));
        lifecycleManager.registerEventListener("test-component-2", comp1, "data-added", (_data) => console.log(`Comp2 escuchó: ${_data}`));
...
//# sourceMappingURL=test_lifecycle_manager.js.map