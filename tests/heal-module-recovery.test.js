...
describe("Heal Module - Timer Management & V401 Validation", () => {
    ...
    beforeEach(() => {
        jest.clearAllMocks();
        heal = new SeleneHeal(mockServer, mockDatabase, mockCache, mockMonitoring, mockVeritas);
    });
    afterEach(() => {
    ...
    describe("Heal Module Initialization", () => {
        ...
        test("should initialize without throwing errors", () => {
            expect(() => {
                const testHeal = new SeleneHeal(mockServer, mockDatabase, mockCache, mockMonitoring, mockVeritas);
...
//# sourceMappingURL=heal-module-recovery.test.js.map